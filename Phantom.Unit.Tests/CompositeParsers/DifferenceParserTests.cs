...
namespace Phantom.Unit.Tests.CompositeParsers
{
	...
	public class DifferenceParserTests
	{
		...
		{
			var subject = new Difference(__this__, __this_is__);
		...
		{
			var subject = new Difference(__this__, __wally__);
		...
		{
			var subject = new Difference(__wally__, __this__);
		...
		{
			var subject = new Difference(__wally__, __dr_jones__);
