...
namespace Phantom.Parsers {
	...
	public abstract class Parser:Rule{
		...
		/// </summary>
		public bool IsAtomic { get { return AtomFlag != null; } }
		...
		public virtual SemanticActionArgs OnAction (Parsers.ParserMatch m) {
			if (Actor != null) {
		...
		public Parser this[SemanticAction action] {
			get {
				this.Actor += action;	// add the handler
		...
		public static implicit operator Parser(char c) {
			return new Terminals.LiteralCharacter(c);
		}
		/// <summary>
		...
		public static implicit operator Parser(string s) {
			...
			if (s.StartsWith("#")) {
				...
				if (!pattern.StartsWith("#")) {
					return new Terminals.RegularExpression(pattern, false);
				}
			} else {
				pattern = s;
			}
			return new Terminals.LiteralString(pattern);
		}
		#endregion
		...
		public static Parser operator >(Parser a, Parser b) {
			...
			return new Composite.Sequence(a, b);
		}
		/// <summary>
		...
		public static Parser operator <(Parser a, Parser b) {
			...
			return new Composite.TerminatedList(a, b);
		}
		#endregion
		...
		public static Parser operator -(Parser a) {
			...
			return new Composite.Repetition(a, 0, uint.MaxValue);
		}
		...
		public static Parser operator +(Parser a) {
			...
			return new Composite.Repetition(a, 1, uint.MaxValue);
		}
		...
		public static Parser operator !(Parser a) {
			...
			return new Composite.Repetition(a, 0, 1);
		}
		...
		public static Parser operator %(Parser a, Parser b) {
			...
			return new Composite.DelimitedList(a, b);
		}
		#endregion
		...
		public static Parser operator |(Parser a, Parser b) {
			...
			return new Composite.Union(a, b);
		}
		...
		public static Parser operator &(Parser a, Parser b) {
			...
			return new Composite.Intersection(a, b);
		}
		...
		public static Parser operator ^(Parser a, Parser b) {
			...
			return new Composite.Exclusive(a, b);
		}
		#endregion
